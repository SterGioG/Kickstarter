...
describe('Campaigns', () => {
    ...
    it('allows people to contribute money and marks them as approvers', async () => {
        ...
        const isContributor = await campaign.methods.approvers(accounts[1]).call(); // should return true boolean
        assert(isContributor); // will pass if true and fail if false
    });
    ...
    it('allows a manager to make a payment requst', async () => {
    ...
    it('processes requests', async() => {
        ...
        balance = parseFloat(balance); // turns string into decimnal number
        console.log(balance);
        assert(balance > 104);
    });
});